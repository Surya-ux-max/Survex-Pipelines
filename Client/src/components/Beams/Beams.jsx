...
const CanvasWrapper = ({ children }) => (
  <Canvas dpr={[1, 2]} frameloop="always" className="w-full h-full relative" style={{ minHeight: '350px' }}>
    {children}
  </Canvas>
);
...
const Beams = ({
  ...
  return (
    <CanvasWrapper>
      ...
      <color attach="background" args={['#172B36']} /> {/* Match Oceanic Noir */}
...
const MergedPlanes = forwardRef(({ material, width, count, height }, ref) => {
  ...
  const geometry = useMemo(
    () => createStackedPlanesBufferGeometry(count, width, height, 0.4, 100),
    [count, width, height]
  );
  useFrame((_, delta) => {
