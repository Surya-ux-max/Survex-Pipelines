      ...
      <div className="container">
        <div className="footer-top">
          ...
          <div className="footer-brand-col">
            ...
            <div className="footer-social" aria-label="Social links" style={{ marginTop: '1.5rem', display: 'flex', gap: '1rem', justifyContent: 'flex-start' }}>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="Survex GitHub">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
                </svg>
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Survex Twitter">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li><a href="#pipeline">Marquee Flow</a></li>
          ...
          <div>
            ...
            <ul className="footer-links">
              ...
              <li>
                <a href="#" style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                  API Status 
          ...
          <div className="footer-subscribe-col">
            ...
            <p className="footer-subscribe-text">
              Stay updated on pipeline security protocols and schema validation updates.
            </p>
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">
            &copy; {currentYear} Survex Inc. All rights reserved. Run with precision.
          </div>
          <div className="footer-terms">
            <a href="#" style={{ marginRight: '1rem' }}>Terms</a>
            <a href="#">Privacy</a>
          </div>
        </div>
